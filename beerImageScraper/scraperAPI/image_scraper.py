...
def fetch_image_urls(query, quantity, headers, start=0):
    ...
    while len(unique_image_urls) < quantity:
        ...
        for img_tag in img_tags:
            ...
            if (
                img_url and img_url.startswith('http')  
                and img_url not in unique_image_urls  
            ):
...
def main():
    ...
    parser.add_argument('-d', '--directory', default='C:/Users/suj33/Desktop/iBeer.ai/beerImageScraper/beerImages', type=str, help='Directory to save images')
